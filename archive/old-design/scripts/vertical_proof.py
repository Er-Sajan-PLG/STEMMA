...
def main() -> int:
    ...
    halliday_src = sources_dir / "stemma:src.halliday-resnick.yaml"
    ...
    print("  [Simulated] Source candidate created: stemma:src.halliday-resnick")
    ...
    result = run([
        ...
        "--data", '{"canonical_ref": "stemma:phys.work-energy-theorem", "source_ref": "stemma:src.halliday-resnick", "evidence_refs": ["stemma:evidence.work-energy-001"], "reviewer": "human:reviewer.physics-001"}'
