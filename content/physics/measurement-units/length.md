...
definition: 'Length is the SI base physical quantity of spatial extent — the measure
  ...
  during 1/299,792,458 of a second (c fixed exact). Agreed per BIPM SI Brochure 9th
  ed. (2019), base quantities table; §2.3.1.'
symbol: L
unit: metre (m)
...
provenance:
  ...
  source: 'BIPM SI Brochure 9th ed. (2019): among the seven SI base quantities, length
    with base unit metre; metre defined by fixed numerical value of c in vacuum (2.3.1).'
