...
- Deterministic, content-hash stamped, no wall clock, versioned exports v2.1.0, single source VERSION.yaml
...
- Paths: exports/knowledge.json v2.1.0 content-hash, embeddings.jsonl, vector_store/ FAISS meta.json + vectors.npy + ids.json, consumers/<consumer>/knowledge.<consumer>.json, openapi.yaml, reports/
