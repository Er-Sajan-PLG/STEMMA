...
- `same_dimensional_quantities`: mandatory on ALL entity files (owner directive 2026-09-22) — non-empty list for quantity/unit (SI dimension-class members / quantities expressible in the unit), explicit `null` for types where the notion does not apply (law etc.)
